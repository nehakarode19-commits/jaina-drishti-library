  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (file && file.size > 0) {
        toast({
          title: "Note",
          description: "File upload will be available once storage is configured.",
        });
      }
      ...
      toast({
        ...
        description: "Your book upload request has been submitted successfully. We'll review it soon.",
      });
      ...
      if (error instanceof z.ZodError) {
        ...
        toast({
          ...
          description: "Failed to submit upload request. Please try again.",
          variant: "destructive",
        });
      }
    } finally {
        ...
        <div className="container max-w-4xl">
          ...
          <div className="bg-[#FEF7E7] rounded-lg p-8 md:p-12 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="file" className="text-[#6B5D3F] font-medium">
                  Upload Book
                </Label>
                <div className="relative">
                  <Input
                    ...
                    className="bg-white border-[#D4C5A0] file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#5C5133] file:text-white hover:file:bg-[#4A4129]"
                  />
                  {fileName && (
                    <div className="mt-2 text-sm text-[#6B5D3F] flex items-center gap-2">
