                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{publisher.nameNative}</p>
                      </div>
                      <div className="text-right">
                        <span className="text-sm font-medium text-primary">{publisher.language}</span>
                        <p className="text-sm text-muted-foreground">{publisher.mool}</p>
                      </div>
                    </div>
                    
                    <div className="space-y-1 text-sm mb-3">
                      <div className="flex gap-4">
                        <span>Sutrat#: <span className="font-semibold">{publisher.sutrat}</span></span>
                        <span>Type: <span className="font-semibold">{publisher.type}</span></span>
                        {publisher.section && <span>Section: <span className="font-semibold">{publisher.section}</span></span>}
                      </div>
                      <p className="text-muted-foreground">{publisher.agam}</p>
                    </div>
